...
def SUMANUEVA(num1,num2): #"Acordarse siempre de poner :"
    s= num1 + num2
...
s,boll,string=SUMANUEVA(num2=50,num1=50) #Devuelve lo multiples valores de retunr, por orden de devolucion
print("4-------")
print("La suma total es:",s)
